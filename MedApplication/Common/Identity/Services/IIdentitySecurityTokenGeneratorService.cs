...
public interface IIdentitySecurityTokenGeneratorService
{
    ...
    AccessToken GenerateAccessToken(UserModule user);
    ...
    RefreshToken GenerateRefreshToken(UserModule user, bool extendedExpiryTime = false);
    ...
    JwtSecurityToken GetToken(UserModule user, AccessToken accessToken);
    ...
    List<Claim> GetClaims(UserModule user, AccessToken accessToken);
}
