...
public interface IUserModuleService
{
    ...
    UserModule CreateAsync(UserModule user, bool saveChanges = true, CancellationToken cancellationToken = default);
    ...
    UserModule UpdateAsync(UserModule user, bool saveChanges = true, CancellationToken cancellationToken = default);
